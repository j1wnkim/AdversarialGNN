...
class RandomizedResopnse:
    def __init__(self, eps, d): # d is the number of clases. 
        self.d = d
        self.q = 1.0 / (math.exp(eps) + self.d - 1) # q is the probability of a fake class. 
        self.p = self.q * math.exp(eps) # p is the probability of the true class.

    def __call__(self, y): # y is the one hot encoder of true class with respect to other classes. 
